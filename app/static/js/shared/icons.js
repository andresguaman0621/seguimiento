/* Componente Icon: SVG en línea (set curado de Lucide, MIT License).
   Autocontenido, sin dependencia de CDN de iconos en tiempo de ejecución. */
(function () {
  const PATHS = {
    dashboard:
  ...
  const Icon = {
    ...
    template:
      ...
      'stroke-linejoin="round" class="icon" v-html="inner"></svg>',
  };
